@extends('admin.base.v-app', ['title' => 'Tambah Carousel'])
@section('content')
        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item"><a href="{{ route('admin.carousel.index') }}">Back</a></div>
                    <div class="breadcrumb-item">Tambah Carousel</div>
                </div>
            </div>
            ...
            <div class="section-body">
                <form action="{{ route('admin.carousel.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="isbutton" value="1" id="defaultCheck1">

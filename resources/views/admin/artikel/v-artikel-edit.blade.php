@extends('admin.base.v-app', ['title' => 'Edit Article'])
@section('content')
            ...
            <form action="{{ route('admin.artikel.update', $item->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input id="judul" type="text" class="form-control  @error('judul') is-invalid @enderror"
                        name="judul" tabindex="1" value='{{ $item->judul }}' autofocus>
                ...
                <div class="form-group">
                    ...
                    <div>
                        <small>Seperti contoh : <strong><i>"Langkah-langkah Pembuatan Surat Kuasa di Notaris"</i></strong></small>
                    </div>
                    <textarea name="judul2" class="form-control @error('judul2') is-invalid @enderror" id="judul2"
                        rows="3">{{ $item->judul2 }}</textarea>
                    <div class="invalid-feedback">
                        @error('judul2')
                            {{ $message }}
                        @enderror

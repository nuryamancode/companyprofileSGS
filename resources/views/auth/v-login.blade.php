                ...
                <div class="row">
                    <div
                        ...
                        <div class="login-brand">
                                                        <h1 class="text-white fw-bold d-block"><img src="{{ asset('assets/img/SGS.png') }}" class="img-fluid logo" style="width: 110px"  alt=""></h1>
                        ...
                        <div class="simple-footer">
                            Copyright &copy; Satria Global Solusi 2024
                        </div>
                    </div>
                </div>
            </div>

...
@section('content')
    ...
    <div class="container-fluid mt-5 py-3">
        <div class="container text-center mt-5">
            <h1 class="display-2 mt-5 text-primary mb-4 animated slideInDown">{{ GoogleTranslate::trans('Article Detail',\App::getLocale()) }}</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb justify-content-center mb-0">
                    <li class="breadcrumb-item"><a href="{{ route('home') }}">{{ GoogleTranslate::trans('Home',\App::getLocale()) }}</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('article') }}">{{ GoogleTranslate::trans('Back',\App::getLocale()) }}</a></li>
                    <li class="breadcrumb-item" aria-current="page">{{ GoogleTranslate::trans('Article Detail',\App::getLocale()) }}</li>
                </ol>
            </nav>
        </div>
    </div>
                ...
                <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay=".3s">
                    <div class="project-item">
                        ...
                        <div class="project-img">
                            <img src="{{ asset('artikel/' . $data->foto) }}" class="img-fluid w-100 rounded"
                            alt="">
                        </div>
                    </div>
                </div>
